...
<!--                  <i class="el-icon-female" style="color: deeppink"/>-->
          ...
          <el-main>
            <el-menu :default-active="$route.path" router  mode="horizontal" class="menu">
              <el-menu-item :index=url1>关注的专题/文集</el-menu-item>
              <el-menu-item :index=url2>喜欢的文章</el-menu-item>
            </el-menu>
          </el-main>
    ...
    getUserInfo () {
      ...
      this.axios.get('/api/user/info/' + _this.$route.params.id).then(function (res) {
        if (res.data.code) {
          ...
          _this.url1 = '/users/' + _this.$route.params.id + '/subscriptions'
          _this.url2 = '/users/' + _this.$route.params.id + '/subscriptions/liked_notes'
        }
      })
    },
    getTopics () {
